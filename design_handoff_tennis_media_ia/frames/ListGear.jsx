    ...
    <Phone>
      ...
      <div style={{padding:'20px 14px 0'}}>
        ...
        <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:10}}>
          {[
            { brand: 'BABOLAT', name: 'Pure Aero 98 (2026)', price: '¥46,200', tag: 'NEW' },
            { brand: 'WILSON', name: 'Blade 98 v9', price: '¥42,900', tag: '' },
            { brand: 'HEAD', name: 'Speed MP 2026', price: '¥44,000', tag: 'NEW' },
            { brand: 'YONEX', name: 'EZONE 100 (2026)', price: '¥40,700', tag: '' },
          ].map((c, i) => (
            <div key={i} style={{background:'#fff', border:'1px solid var(--wf-line)'}}>
              ...
              <div style={{padding:'7px 8px 9px'}}>
                <div style={{fontSize:9, color:'var(--wf-mute)', letterSpacing:'0.06em', fontWeight:700}}>{c.brand}</div>
                <div style={{fontSize:11.5, fontWeight:700, lineHeight:1.3, marginTop:2}}>{c.name}</div>
                <div className="wf-num" style={{fontSize:11, fontWeight:800, marginTop:5}}>{c.price}</div>
              </div>
            </div>
          ))}
        </div>
      ...
      <div style={{padding:'22px 0 0'}}>
        ...
        <div style={{padding:'0 0 0 14px', display:'flex', gap:10, overflowX:'auto'}}>
          {[
            { brand: 'NIKE', name: 'Zoom Vapor Cage 4' },
            { brand: 'ASICS', name: 'Court FF 3' },
            { brand: 'ADIDAS', name: 'Barricade 13' },
          ].map((c, i) => (
            <div key={i} style={{
              ...
              <div style={{padding:'7px 8px 9px'}}>
                <div style={{fontSize:9, color:'var(--wf-mute)', fontWeight:700, letterSpacing:'0.06em'}}>{c.brand}</div>
                <div style={{fontSize:11, fontWeight:700, lineHeight:1.3, marginTop:2}}>{c.name}</div>
              </div>
            </div>
          ))}
        </div>
