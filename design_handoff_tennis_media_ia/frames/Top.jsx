    ...
    <Phone>
      ...
      <div style={{padding:'20px 0 0', background:'var(--wf-bg-2)', margin:'20px 0 0', paddingTop:18, paddingBottom:18}}>
        ...
        <div style={{padding:'0 0 0 14px', display:'flex', gap:10, overflowX:'auto'}}>
          {[
            { brand: 'BABOLAT', name: 'Pure Aero 98 (2026)', price: '¥46,200' },
            { brand: 'WILSON', name: 'Blade 98 v9', price: '¥42,900' },
            { brand: 'HEAD', name: 'Speed MP 2026', price: '¥44,000' },
          ].map((c, i) => (
            <div key={i} style={{
              flex:'0 0 140px', background:'#fff', border:'1px solid var(--wf-line)',
              marginRight: i === 2 ? 14 : 0,
            }}>
              <ImgPh w="100%" h={100} label="racket" />
              <div style={{padding:'7px 8px'}}>
                ...
                <div className="wf-num" style={{fontSize:11, fontWeight:800, marginTop:4}}>{c.price}</div>
              </div>
            </div>
          ))}
        </div>
