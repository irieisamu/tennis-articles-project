...
function CMSFrame() {
  return (
    <Phone height={820}>
      ...
      <div style={{background:'#e8e6df', padding:'10px', minHeight:'100%'}}>

        {/* ── 基本情報 ── */}
        <div style={{background:'#fff', padding:'10px 12px', marginBottom:10, border:'1px solid var(--wf-line)'}}>
        ...
        <div style={{
          ...
          {['+ 見出し','+ 本文','+ 画像','+ スペック表','+ 比較表','+ CTA','+ フォーム','+ HTML'].map((t,i) => (
            <div key={i} style={{
              flex:'0 0 auto', padding:'6px 8px', fontSize:10.5, fontWeight:700,
